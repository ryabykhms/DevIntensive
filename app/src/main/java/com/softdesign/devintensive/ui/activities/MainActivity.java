...
import com.softdesign.devintensive.utils.RoundedPhotoDrawable;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setupDrawer() {
        ...
        ImageView mDrawerPhoto = (ImageView) headerView.findViewById(R.id.user_photo_drawer_img);
        mDrawerPhoto.setImageBitmap(RoundedPhotoDrawable.getRoundedBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.userphoto)));
